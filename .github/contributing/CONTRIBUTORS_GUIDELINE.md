# 🌟 Contributing Guide | StarProof

We're thrilled that you're interested in contributing to **StarProof**! Please follow the steps below to ensure a seamless and efficient collaboration process.
...
1. Clone the forked repository to your local machine by running the following command:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/StarProof.git
   ```
...
1. **Follow branch naming conventions** outlined in the [Git Guidelines](https://github.com/StarProofCR/Landing/blob/main/GIT_GUIDELINE.md).
...
- Follow the [Git Guidelines](https://github.com/StarProofCR/Landing/blob/main/GIT_GUIDELINE.md) for branch naming, commit messages, and overall contribution standards.
